"""
Face Recognition System - Real-Time Recognition
Real-time face recognition using MediaPipe for detection and LBPH for recognition
Part 3 of 3: Live Detection and Recognition Pipeline
"""
import cv2
