"""
Face Recognition System - Training Data Capture
Uses MediaPipe for face detection to capture and organize training images
Part 1 of 3: Data Collection Module
"""
import cv2
...
def main():
    ...
    print("="*60)
    print("Face Recognition System - Training Data Capture")
