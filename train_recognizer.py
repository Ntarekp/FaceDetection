"""
Face Recognition System - Model Training
Trains LBPH Face Recognizer on captured face images
Part 2 of 3: Training Module for Classical Feature-Based Recognition
"""
import cv2
import os
import json
...
class LBPHTrainer:
    ...
    def train(self):
        ...
        print("Next step: Run 'run_face_recognition.py' for face recognition")
        print(f"{'='*60}\n")
...
def main():
    ...
    print("="*60)
    print("Face Recognition System - Model Training")
